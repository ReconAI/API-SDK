...
ALTER TABLE ONLY public."Users" DROP CONSTRAINT "Users_organizationId_64318c7f_fk_Organizations_id";
ALTER TABLE ONLY public."TrainingInstructionsLabelDatasets" DROP CONSTRAINT "TrainingInstructions_labelDatasetId_516be3ef_fk_LabelData";
ALTER TABLE ONLY public."TrainingInstructions" DROP CONSTRAINT "TrainingInstructions_dataSplitInst_f2f86e68_fk_DataSplit";
ALTER TABLE ONLY public."TrainingInstructionsLabelDatasets" DROP CONSTRAINT "TrainingInstructions_TrainingInstId_74880888_fk_TrainingI";
ALTER TABLE ONLY public."RoadConditions" DROP CONSTRAINT "RoadConditions_edgeNodeId_3b89422e_fk_EdgeNodes_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_vehicleClassification_0a8e9bc9_fk_TypeCode_value";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_taggedDataId_1832c8e8_fk_FrameDatasets_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_roadWeatherCondition_9b12a596_fk_TypeCode_value";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_projectId_64f4a338_fk_Projects_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_objectModelId_53c82144_fk_ObjectModels_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_objectClass_38c0bc9d_fk_TypeCode_value";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_licensePlate_dee89b0e_fk_FileStorage_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_featureModelId_8f88e76e_fk_FeatureModels_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_face_259dc2a1_fk_FileStorage_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_eventType_490c94b2_fk_TypeCode_value";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_edgeNodeId_c69a3c7b_fk_EdgeNodes_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_deviceInstanceId_a2862ba9_fk_DeviceInstances_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_cadFileTag_5170c280_fk_FileStorage_id";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_ambientWeatherCondition_da43dbc2_fk_TypeCode_value";
ALTER TABLE ONLY public."RecurrentCharges" DROP CONSTRAINT "RecurrentCharges_organizationId_ea145764_fk_Organizations_id";
ALTER TABLE ONLY public."QuestionXMLs" DROP CONSTRAINT "QuestionXMLs_labelClassId_368ad4d1_fk_LabelClasses_id";
ALTER TABLE ONLY public."Purchases" DROP CONSTRAINT "Purchases_organizationId_60152fc6_fk_Organizations_id";
ALTER TABLE ONLY public."Projects" DROP CONSTRAINT "Projects_organizationId_e13b3813_fk_Organizations_id";
ALTER TABLE ONLY public."Projects" DROP CONSTRAINT "Projects_featuremodelId_4acb5542_fk_FeatureModels_id";
ALTER TABLE ONLY public."Projects" DROP CONSTRAINT "Projects_ecosystemId_c89985e3_fk_Ecosystems_id";
ALTER TABLE ONLY public."ProjectInstructions" DROP CONSTRAINT "ProjectInstructions_validationInstrId_52c3aa32_fk_Validatio";
ALTER TABLE ONLY public."ProjectInstructions" DROP CONSTRAINT "ProjectInstructions_trainingInstrId_9c044f11_fk_TrainingI";
ALTER TABLE ONLY public."ProjectInstructions" DROP CONSTRAINT "ProjectInstructions_projectId_5f3a8bc3_fk_Projects_id";
ALTER TABLE ONLY public."ProjectInstructions" DROP CONSTRAINT "ProjectInstructions_dataAcqInstId_966befae_fk_DataAcqIn";
ALTER TABLE ONLY public."ProjectInstructions" DROP CONSTRAINT "ProjectInstructions_augmentInstId_76598f7f_fk_Augmentat";
ALTER TABLE ONLY public."ProjectInstructions" DROP CONSTRAINT "ProjectInstructions_annotInstId_dd119dea_fk_Annotatio";
ALTER TABLE ONLY public."ProjectEdgeNodes" DROP CONSTRAINT "ProjectEdgeNodes_projectId_691a4a2b_fk_Projects_id";
ALTER TABLE ONLY public."ProjectEdgeNodes" DROP CONSTRAINT "ProjectEdgeNodes_edgeNodeId_190a005d_fk_EdgeNodes_id";
ALTER TABLE ONLY public."OutsourcedInst" DROP CONSTRAINT "OutsourcedInst_questionXMLid_bf4b9751_fk_QuestionXMLs_id";
ALTER TABLE ONLY public."OutsourcedInst" DROP CONSTRAINT "OutsourcedInst_frameDatasetId_a60fd59f_fk_FrameDatasets_id";
ALTER TABLE ONLY public."OutsourcedInst" DROP CONSTRAINT "OutsourcedInst_annotInstId_3258119d_fk_Annotatio";
ALTER TABLE ONLY public."OperationInstances" DROP CONSTRAINT "OperationInstances_operationClassId_3b778f3d_fk_Operation";
ALTER TABLE ONLY public."OperationInstances" DROP CONSTRAINT "OperationInstances_frameDatasetId_bf00fa80_fk_FrameDatasets_id";
ALTER TABLE ONLY public."OperationClassesSupportedLabelClasses" DROP CONSTRAINT "OperationClassesSupp_operationClassId_1eaf8b2e_fk_Operation";
ALTER TABLE ONLY public."OperationClassesSupportedLabelClasses" DROP CONSTRAINT "OperationClassesSupp_labelClassId_d9abb51c_fk_LabelClas";
ALTER TABLE ONLY public."ObjectModelProject" DROP CONSTRAINT "ObjectModelProject_projectId_ba150b15_fk_Projects_id";
ALTER TABLE ONLY public."ObjectModelProject" DROP CONSTRAINT "ObjectModelProject_objectModelId_e6270770_fk_ObjectModels_id";
ALTER TABLE ONLY public."ObjectModelFeatureModel" DROP CONSTRAINT "ObjectModelFeatureMo_objectModelId_30e0c1ab_fk_ObjectMod";
ALTER TABLE ONLY public."ObjectModelFeatureModel" DROP CONSTRAINT "ObjectModelFeatureMo_featureModelId_17a47e4e_fk_FeatureMo";
ALTER TABLE ONLY public."ObjectModelAlgorithmModel" DROP CONSTRAINT "ObjectModelAlgorithm_objectModelId_6d60d413_fk_ObjectMod";
ALTER TABLE ONLY public."ObjectModelAlgorithmModel" DROP CONSTRAINT "ObjectModelAlgorithm_algorithmModelId_aa48e51b_fk_Algorithm";
ALTER TABLE ONLY public."Licenses" DROP CONSTRAINT "Licenses_userId_c973a0e8_fk_Users_id";
ALTER TABLE ONLY public."LabelDatasets" DROP CONSTRAINT "LabelDatasets_parentFrameDatasetId_4a8dd315_fk_FrameDatasets_id";
ALTER TABLE ONLY public."LabelDatasets" DROP CONSTRAINT "LabelDatasets_parentAlgorithmModel_9f060aca_fk_Algorithm";
ALTER TABLE ONLY public."LabelDatasets" DROP CONSTRAINT "LabelDatasets_labelClassId_d1722ec5_fk_LabelClasses_id";
ALTER TABLE ONLY public."LabelData" DROP CONSTRAINT "LabelData_parentFrame_b5ac8646_fk_Frames_id";
ALTER TABLE ONLY public."LabelData" DROP CONSTRAINT "LabelData_labelDatasetId_fc9ceb35_fk_LabelDatasets_id";
ALTER TABLE ONLY public."HITsets" DROP CONSTRAINT "HITsets_questionXMLid_21251f13_fk_QuestionXMLs_id";
ALTER TABLE ONLY public."HITsets" DROP CONSTRAINT "HITsets_frameDatasetId_30f9eec9_fk_FrameDatasets_id";
ALTER TABLE ONLY public."HITsets" DROP CONSTRAINT "HITsets_assocLabelsetId_e11ceaa0_fk_LabelDatasets_id";
ALTER TABLE ONLY public."Frames" DROP CONSTRAINT "Frames_frameDatasetId_8b22b6d3_fk_FrameDatasets_id";
ALTER TABLE ONLY public."FrameDatasets" DROP CONSTRAINT "FrameDatasets_DataAcqInstructionsI_4a926a5f_fk_DataAcqIn";
ALTER TABLE ONLY public."FrameDatasetsProjects" DROP CONSTRAINT "FrameDatasetsProjects_projectId_78fc58d8_fk_Projects_id";
ALTER TABLE ONLY public."FrameDatasetsProjects" DROP CONSTRAINT "FrameDatasetsProject_frameDatasetId_e8269981_fk_FrameData";
ALTER TABLE ONLY public."FeatureModelAlgorithm" DROP CONSTRAINT "FeatureModelAlgorith_featureModelId_f1b2874e_fk_FeatureMo";
ALTER TABLE ONLY public."FeatureModelAlgorithm" DROP CONSTRAINT "FeatureModelAlgorith_algorithmModelId_0b536e71_fk_Algorithm";
ALTER TABLE ONLY public."FeatureInstances" DROP CONSTRAINT "FeatureInstances_projectId_c180e7f4_fk_Projects_id";
ALTER TABLE ONLY public."FeatureInstances" DROP CONSTRAINT "FeatureInstances_parentECUclass_dde0fcdf_fk_DeviceClasses_id";
ALTER TABLE ONLY public."FeatureInstances" DROP CONSTRAINT "FeatureInstances_featureModelId_2acc714d_fk_FeatureModels_id";
ALTER TABLE ONLY public."FeatureInstanceAlgorithm" DROP CONSTRAINT "FeatureInstanceAlgor_featureInstanceId_54668682_fk_FeatureIn";
ALTER TABLE ONLY public."FeatureInstanceAlgorithm" DROP CONSTRAINT "FeatureInstanceAlgor_algorithmId_461edd16_fk_Algorithm";
ALTER TABLE ONLY public."EventsHistory" DROP CONSTRAINT "EventsHistory_edgeNodeId_5490a224_fk_EdgeNodes_id";
ALTER TABLE ONLY public."EdgeNodes" DROP CONSTRAINT "EdgeNodes_organizationId_9ee23a70_fk_Organizations_id";
ALTER TABLE ONLY public."EdgeNodes" DROP CONSTRAINT "EdgeNodes_dockerInstanceId_b0d7c0a7_fk_DockerInstances_id";
ALTER TABLE ONLY public."EdgeNodeDevices" DROP CONSTRAINT "EdgeNodeDevices_edgeNodeId_f5c57da1_fk_EdgeNodes_id";
ALTER TABLE ONLY public."EdgeNodeDevices" DROP CONSTRAINT "EdgeNodeDevices_deviceInstanceId_d6c01c28_fk_DeviceInstances_id";
ALTER TABLE ONLY public."Ecosystems" DROP CONSTRAINT "Ecosystems_organizationId_28330099_fk_Organizations_id";
ALTER TABLE ONLY public."EcosystemsEdgeNodes" DROP CONSTRAINT "EcosystemsEdgeNodes_edgeNodeId_7f9d3833_fk_EdgeNodes_id";
ALTER TABLE ONLY public."EcosystemsEdgeNodes" DROP CONSTRAINT "EcosystemsEdgeNodes_ecosystemId_ad643413_fk_Ecosystems_id";
ALTER TABLE ONLY public."DockerModelFeatureModel" DROP CONSTRAINT "DockerModelFeatureMo_featureModelId_88cb3c4c_fk_FeatureMo";
ALTER TABLE ONLY public."DockerModelFeatureModel" DROP CONSTRAINT "DockerModelFeatureMo_dockerModelId_c9abbb63_fk_DockerMod";
ALTER TABLE ONLY public."DockerModelDeviceClasses" DROP CONSTRAINT "DockerModelDeviceCla_dockerModelId_1fc8f861_fk_DockerMod";
ALTER TABLE ONLY public."DockerModelDeviceClasses" DROP CONSTRAINT "DockerModelDeviceCla_deviceClassId_7f5e0439_fk_DeviceCla";
ALTER TABLE ONLY public."DockerInstances" DROP CONSTRAINT "DockerInstances_dockerModelId_c0e5906d_fk_DockerModels_id";
ALTER TABLE ONLY public."Devices" DROP CONSTRAINT "Devices_manufacturerId_190a216d_fk_Manufacturers_id";
ALTER TABLE ONLY public."Devices" DROP CONSTRAINT "Devices_categoryId_9734dab2_fk_Categories_id";
ALTER TABLE ONLY public."DevicePurchases" DROP CONSTRAINT "DevicePurchases_orderId_018cdbfa_fk_Purchases_id";
ALTER TABLE ONLY public."DevicePurchases" DROP CONSTRAINT "DevicePurchases_deviceId_3a5d8103_fk_Devices_id";
ALTER TABLE ONLY public."DeviceInstances" DROP CONSTRAINT "DeviceInstances_deviceClassId_4175d8f1_fk_DeviceClasses_id";
ALTER TABLE ONLY public."DeviceImages" DROP CONSTRAINT "DeviceImages_device_id_ee33261e_fk_Devices_id";
ALTER TABLE ONLY public."DeviceClasses" DROP CONSTRAINT "DeviceClasses_deviceParameterId_a25c5229_fk_DeviceParameters_id";
ALTER TABLE ONLY public."DetectionsSummary" DROP CONSTRAINT "DetectionsSummary_edgeNodeId_1bef6f49_fk_EdgeNodes_id";
ALTER TABLE ONLY public."DetectedObjects" DROP CONSTRAINT "DetectedObjects_fileId_6ee54399_fk_FileStorage_id";
ALTER TABLE ONLY public."DetectedObjects" DROP CONSTRAINT "DetectedObjects_edgeNodeId_8d45f531_fk_EdgeNodes_id";
ALTER TABLE ONLY public."AugmentationInstructions" DROP CONSTRAINT "AugmentationInstructions_projectId_422bc6a4_fk_Projects_id";
ALTER TABLE ONLY public."AugmentationInstructions" DROP CONSTRAINT "AugmentationInstruct_frameDatasetId_06c5cfe8_fk_FrameData";
ALTER TABLE ONLY public."AlgorithmModels" DROP CONSTRAINT "AlgorithmModels_initWeights_97fc8647_fk_Weights_id";
ALTER TABLE ONLY public."AlgorithmModels" DROP CONSTRAINT "AlgorithmModels_architectureId_3b8b2a10_fk_Architectures_id";
ALTER TABLE ONLY public."AlgorithmInstances" DROP CONSTRAINT "AlgorithmInstances_weightId_479a600a_fk_Weights_id";
ALTER TABLE ONLY public."AlgorithmInstances" DROP CONSTRAINT "AlgorithmInstances_projectId_a1901360_fk_Projects_id";
ALTER TABLE ONLY public."AlgorithmInstances" DROP CONSTRAINT "AlgorithmInstances_algorithmModelId_812a2349_fk_Algorithm";
ALTER TABLE ONLY public."AlgorithmInstanceTrainingInst" DROP CONSTRAINT "AlgorithmInstanceTra_trainingInstructionI_9ee173b8_fk_TrainingI";
ALTER TABLE ONLY public."AlgorithmInstanceTrainingInst" DROP CONSTRAINT "AlgorithmInstanceTra_algorithmInstanceId_c74bf0d6_fk_Algorithm";
ALTER TABLE ONLY public."AlgorithmInstanceObjectModel" DROP CONSTRAINT "AlgorithmInstanceObj_objectModelId_a413348a_fk_ObjectMod";
ALTER TABLE ONLY public."AlgorithmInstanceObjectModel" DROP CONSTRAINT "AlgorithmInstanceObj_algorithmInstanceId_08b65b52_fk_Algorithm";
ALTER TABLE ONLY public."AlgorithmInstanceDeployedDevices" DROP CONSTRAINT "AlgorithmInstanceDep_deployedDeviceInstan_c6c562c1_fk_DeviceIns";
ALTER TABLE ONLY public."AlgorithmInstanceDeployedDevices" DROP CONSTRAINT "AlgorithmInstanceDep_algorithmInstanceId_37ca6367_fk_Algorithm";
DROP INDEX public.recon_db_manager_deviceimage_device_id_55ebffb5;
DROP INDEX public."Users_username_c7f288a1_like";
DROP INDEX public."Users_organizationId_64318c7f";
DROP INDEX public."Users_email_93eda431_like";
DROP INDEX public."TypeCode_value_83ec098e_like";
DROP INDEX public."TrainingInstructions_dataSplitInst_f2f86e68";
DROP INDEX public."TrainingInstructionsLabelDatasets_labelDatasetId_516be3ef";
DROP INDEX public."TrainingInstructionsLabelDatasets_TrainingInstId_74880888";
DROP INDEX public."RoadConditions_edgeNodeId_3b89422e";
DROP INDEX public."RelevantData_vehicleClassification_0a8e9bc9_like";
DROP INDEX public."RelevantData_vehicleClassification_0a8e9bc9";
DROP INDEX public."RelevantData_taggedDataId_1832c8e8";
DROP INDEX public."RelevantData_roadWeatherCondition_9b12a596_like";
DROP INDEX public."RelevantData_roadWeatherCondition_9b12a596";
DROP INDEX public."RelevantData_projectId_64f4a338";
DROP INDEX public."RelevantData_objectModelId_53c82144";
DROP INDEX public."RelevantData_objectClass_38c0bc9d_like";
DROP INDEX public."RelevantData_objectClass_38c0bc9d";
DROP INDEX public."RelevantData_licensePlate_dee89b0e";
DROP INDEX public."RelevantData_featureModelId_8f88e76e";
DROP INDEX public."RelevantData_face_259dc2a1";
DROP INDEX public."RelevantData_eventType_490c94b2_like";
DROP INDEX public."RelevantData_eventType_490c94b2";
DROP INDEX public."RelevantData_edgeNodeId_c69a3c7b";
DROP INDEX public."RelevantData_deviceInstanceId_a2862ba9";
DROP INDEX public."RelevantData_cadFileTag_5170c280";
DROP INDEX public."RelevantData_ambientWeatherCondition_da43dbc2_like";
DROP INDEX public."RelevantData_ambientWeatherCondition_da43dbc2";
DROP INDEX public."RecurrentCharges_organizationId_ea145764";
DROP INDEX public."QuestionXMLs_labelClassId_368ad4d1";
DROP INDEX public."Purchases_organizationId_60152fc6";
DROP INDEX public."Projects_organizationId_e13b3813";
DROP INDEX public."Projects_featuremodelId_4acb5542";
DROP INDEX public."Projects_ecosystemId_c89985e3";
DROP INDEX public."ProjectInstructions_validationInstrId_52c3aa32";
DROP INDEX public."ProjectInstructions_trainingInstrId_9c044f11";
DROP INDEX public."ProjectInstructions_projectId_5f3a8bc3";
DROP INDEX public."ProjectInstructions_dataAcqInstId_966befae";
DROP INDEX public."ProjectInstructions_augmentInstId_76598f7f";
DROP INDEX public."ProjectInstructions_annotInstId_dd119dea";
DROP INDEX public."ProjectEdgeNodes_projectId_691a4a2b";
DROP INDEX public."ProjectEdgeNodes_edgeNodeId_190a005d";
DROP INDEX public."OutsourcedInst_questionXMLid_bf4b9751";
DROP INDEX public."OutsourcedInst_frameDatasetId_a60fd59f";
DROP INDEX public."OutsourcedInst_annotInstId_3258119d";
DROP INDEX public."OperationInstances_operationClassId_3b778f3d";
DROP INDEX public."OperationInstances_frameDatasetId_bf00fa80";
DROP INDEX public."OperationClassesSupportedLabelClasses_operationClassId_1eaf8b2e";
DROP INDEX public."OperationClassesSupportedLabelClasses_labelClassId_d9abb51c";
DROP INDEX public."ObjectModelProject_projectId_ba150b15";
DROP INDEX public."ObjectModelProject_objectModelId_e6270770";
DROP INDEX public."ObjectModelFeatureModel_objectModelId_30e0c1ab";
DROP INDEX public."ObjectModelFeatureModel_featureModelId_17a47e4e";
DROP INDEX public."ObjectModelAlgorithmModel_objectModelId_6d60d413";
DROP INDEX public."ObjectModelAlgorithmModel_algorithmModelId_aa48e51b";
DROP INDEX public."Licenses_userId_c973a0e8";
DROP INDEX public."LabelDatasets_parentFrameDatasetId_4a8dd315";
DROP INDEX public."LabelDatasets_parentAlgorithmModelId_9f060aca";
DROP INDEX public."LabelDatasets_labelClassId_d1722ec5";
DROP INDEX public."LabelData_parentFrame_b5ac8646";
DROP INDEX public."LabelData_labelDatasetId_fc9ceb35";
DROP INDEX public."HITsets_questionXMLid_21251f13";
DROP INDEX public."HITsets_frameDatasetId_30f9eec9";
DROP INDEX public."HITsets_assocLabelsetId_e11ceaa0";
DROP INDEX public."Frames_frameDatasetId_8b22b6d3";
DROP INDEX public."FrameDatasets_DataAcqInstructionsId_4a926a5f";
DROP INDEX public."FrameDatasetsProjects_projectId_78fc58d8";
DROP INDEX public."FrameDatasetsProjects_frameDatasetId_e8269981";
DROP INDEX public."FeatureModelAlgorithm_featureModelId_f1b2874e";
DROP INDEX public."FeatureModelAlgorithm_algorithmModelId_0b536e71";
DROP INDEX public."FeatureInstances_projectId_c180e7f4";
DROP INDEX public."FeatureInstances_parentECUclass_dde0fcdf";
DROP INDEX public."FeatureInstances_featureModelId_2acc714d";
DROP INDEX public."FeatureInstanceAlgorithm_featureInstanceId_54668682";
DROP INDEX public."FeatureInstanceAlgorithm_algorithmId_461edd16";
DROP INDEX public."EventsHistory_edgeNodeId_5490a224";
DROP INDEX public."EdgeNodes_organizationId_9ee23a70";
DROP INDEX public."EdgeNodes_dockerInstanceId_b0d7c0a7";
DROP INDEX public."EdgeNodeDevices_edgeNodeId_f5c57da1";
DROP INDEX public."EdgeNodeDevices_deviceInstanceId_d6c01c28";
DROP INDEX public."Ecosystems_organizationId_28330099";
DROP INDEX public."EcosystemsEdgeNodes_edgeNodeId_7f9d3833";
DROP INDEX public."EcosystemsEdgeNodes_ecosystemId_ad643413";
DROP INDEX public."DockerModelFeatureModel_featureModelId_88cb3c4c";
DROP INDEX public."DockerModelFeatureModel_dockerModelId_c9abbb63";
DROP INDEX public."DockerModelDeviceClasses_dockerModelId_1fc8f861";
DROP INDEX public."DockerModelDeviceClasses_deviceClassId_7f5e0439";
DROP INDEX public."DockerInstances_dockerModelId_c0e5906d";
DROP INDEX public."Devices_manufacturerId_190a216d";
DROP INDEX public."Devices_categoryId_9734dab2";
DROP INDEX public."DevicePurchases_orderId_018cdbfa";
DROP INDEX public."DevicePurchases_deviceId_3a5d8103";
DROP INDEX public."DeviceInstances_deviceClassId_4175d8f1";
DROP INDEX public."DeviceClasses_deviceParameterId_a25c5229";
DROP INDEX public."DetectionsSummary_edgeNodeId_1bef6f49";
DROP INDEX public."DetectedObjects_fileId_6ee54399";
DROP INDEX public."DetectedObjects_edgeNodeId_8d45f531";
DROP INDEX public."AugmentationInstructions_projectId_422bc6a4";
DROP INDEX public."AugmentationInstructions_frameDatasetId_06c5cfe8";
DROP INDEX public."AlgorithmModels_initWeights_97fc8647";
DROP INDEX public."AlgorithmModels_architectureId_3b8b2a10";
DROP INDEX public."AlgorithmInstances_weightId_479a600a";
DROP INDEX public."AlgorithmInstances_projectId_a1901360";
DROP INDEX public."AlgorithmInstances_algorithmModelId_812a2349";
DROP INDEX public."AlgorithmInstanceTrainingInst_trainingInstructionId_9ee173b8";
DROP INDEX public."AlgorithmInstanceTrainingInst_algorithmInstanceId_c74bf0d6";
DROP INDEX public."AlgorithmInstanceObjectModel_objectModelId_a413348a";
DROP INDEX public."AlgorithmInstanceObjectModel_algorithmInstanceId_08b65b52";
DROP INDEX public."AlgorithmInstanceDeployedDevices_algorithmInstanceId_37ca6367";
DROP INDEX public."AlgorithmInstanceDeployedD_deployedDeviceInstanceId_c6c562c1";
ALTER TABLE ONLY public."DeviceImages" DROP CONSTRAINT recon_db_manager_deviceimage_pkey;
...
ALTER TABLE ONLY public."ValidationInstructions" DROP CONSTRAINT "ValidationInstructions_pkey";
ALTER TABLE ONLY public."Users" DROP CONSTRAINT "Users_username_key";
ALTER TABLE ONLY public."Users" DROP CONSTRAINT "Users_pkey";
ALTER TABLE ONLY public."Users" DROP CONSTRAINT "Users_email_93eda431_uniq";
ALTER TABLE ONLY public."TypeCode" DROP CONSTRAINT "TypeCode_value_83ec098e_uniq";
ALTER TABLE ONLY public."TypeCode" DROP CONSTRAINT "TypeCode_pkey";
ALTER TABLE ONLY public."TrainingInstructions" DROP CONSTRAINT "TrainingInstructions_pkey";
ALTER TABLE ONLY public."TrainingInstructionsLabelDatasets" DROP CONSTRAINT "TrainingInstructionsLabelDatasets_pkey";
ALTER TABLE ONLY public."RoadConditions" DROP CONSTRAINT "RoadConditions_pkey";
ALTER TABLE ONLY public."RelevantData" DROP CONSTRAINT "RelevantData_pkey";
ALTER TABLE ONLY public."RecurrentCharges" DROP CONSTRAINT "RecurrentCharges_pkey";
ALTER TABLE ONLY public."QuestionXMLs" DROP CONSTRAINT "QuestionXMLs_pkey";
ALTER TABLE ONLY public."QualityMetricStruct" DROP CONSTRAINT "QualityMetricStruct_pkey";
ALTER TABLE ONLY public."Purchases" DROP CONSTRAINT "Purchases_pkey";
ALTER TABLE ONLY public."Projects" DROP CONSTRAINT "Projects_pkey";
ALTER TABLE ONLY public."ProjectInstructions" DROP CONSTRAINT "ProjectInstructions_pkey";
ALTER TABLE ONLY public."ProjectEdgeNodes" DROP CONSTRAINT "ProjectEdgeNodes_pkey";
ALTER TABLE ONLY public."OutsourcedInst" DROP CONSTRAINT "OutsourcedInst_pkey";
ALTER TABLE ONLY public."Organizations" DROP CONSTRAINT "Organizations_pkey";
ALTER TABLE ONLY public."OperationInstances" DROP CONSTRAINT "OperationInstances_pkey";
ALTER TABLE ONLY public."OperationClasses" DROP CONSTRAINT "OperationClasses_pkey";
ALTER TABLE ONLY public."OperationClassesSupportedLabelClasses" DROP CONSTRAINT "OperationClassesSupportedLabelClasses_pkey";
ALTER TABLE ONLY public."ObjectModels" DROP CONSTRAINT "ObjectModels_pkey";
ALTER TABLE ONLY public."ObjectModelProject" DROP CONSTRAINT "ObjectModelProject_pkey";
ALTER TABLE ONLY public."ObjectModelFeatureModel" DROP CONSTRAINT "ObjectModelFeatureModel_pkey";
ALTER TABLE ONLY public."ObjectModelAlgorithmModel" DROP CONSTRAINT "ObjectModelAlgorithmModel_pkey";
ALTER TABLE ONLY public."Manufacturers" DROP CONSTRAINT "Manufacturers_pkey";
ALTER TABLE ONLY public."Licenses" DROP CONSTRAINT "Licenses_pkey";
ALTER TABLE ONLY public."LabelDatasets" DROP CONSTRAINT "LabelDatasets_pkey";
ALTER TABLE ONLY public."LabelData" DROP CONSTRAINT "LabelData_pkey";
ALTER TABLE ONLY public."LabelClasses" DROP CONSTRAINT "LabelClasses_pkey";
ALTER TABLE ONLY public."HITsets" DROP CONSTRAINT "HITsets_pkey";
ALTER TABLE ONLY public."Frames" DROP CONSTRAINT "Frames_pkey";
ALTER TABLE ONLY public."FrameDatasets" DROP CONSTRAINT "FrameDatasets_pkey";
ALTER TABLE ONLY public."FrameDatasetsProjects" DROP CONSTRAINT "FrameDatasetsProjects_pkey";
ALTER TABLE ONLY public."FileStorage" DROP CONSTRAINT "FileStorage_pkey";
ALTER TABLE ONLY public."FeatureModels" DROP CONSTRAINT "FeatureModels_pkey";
ALTER TABLE ONLY public."FeatureModelAlgorithm" DROP CONSTRAINT "FeatureModelAlgorithm_pkey";
ALTER TABLE ONLY public."FeatureInstances" DROP CONSTRAINT "FeatureInstances_pkey";
ALTER TABLE ONLY public."FeatureInstanceAlgorithm" DROP CONSTRAINT "FeatureInstanceAlgorithm_pkey";
ALTER TABLE ONLY public."EventsHistory" DROP CONSTRAINT "EventsHistory_pkey";
ALTER TABLE ONLY public."EdgeNodes" DROP CONSTRAINT "EdgeNodes_pkey";
ALTER TABLE ONLY public."EdgeNodeDevices" DROP CONSTRAINT "EdgeNodeDevices_pkey";
ALTER TABLE ONLY public."Ecosystems" DROP CONSTRAINT "Ecosystems_pkey";
ALTER TABLE ONLY public."EcosystemsEdgeNodes" DROP CONSTRAINT "EcosystemsEdgeNodes_pkey";
ALTER TABLE ONLY public."DockerModels" DROP CONSTRAINT "DockerModels_pkey";
ALTER TABLE ONLY public."DockerModelFeatureModel" DROP CONSTRAINT "DockerModelFeatureModel_pkey";
ALTER TABLE ONLY public."DockerModelDeviceClasses" DROP CONSTRAINT "DockerModelDeviceClasses_pkey";
ALTER TABLE ONLY public."DockerInstances" DROP CONSTRAINT "DockerInstances_pkey";
ALTER TABLE ONLY public."Devices" DROP CONSTRAINT "Devices_pkey";
ALTER TABLE ONLY public."DevicePurchases" DROP CONSTRAINT "DevicePurchases_pkey";
ALTER TABLE ONLY public."DeviceParameters" DROP CONSTRAINT "DeviceParameters_pkey";
ALTER TABLE ONLY public."DeviceInstances" DROP CONSTRAINT "DeviceInstances_pkey";
ALTER TABLE ONLY public."DeviceClasses" DROP CONSTRAINT "DeviceClasses_pkey";
ALTER TABLE ONLY public."DetectionsSummary" DROP CONSTRAINT "DetectionsSummary_pkey";
ALTER TABLE ONLY public."DetectedObjects" DROP CONSTRAINT "DetectedObjects_pkey";
ALTER TABLE ONLY public."DataSplitInstructions" DROP CONSTRAINT "DataSplitInstructions_pkey";
ALTER TABLE ONLY public."DataAcqInstructions" DROP CONSTRAINT "DataAcqInstructions_pkey";
ALTER TABLE ONLY public."Categories" DROP CONSTRAINT "Categories_pkey";
ALTER TABLE ONLY public."AugmentationInstructions" DROP CONSTRAINT "AugmentationInstructions_pkey";
ALTER TABLE ONLY public."Architectures" DROP CONSTRAINT "Architectures_pkey";
ALTER TABLE ONLY public."AnnotationInstructions" DROP CONSTRAINT "AnnotationInstructions_pkey";
ALTER TABLE ONLY public."AlgorithmModels" DROP CONSTRAINT "AlgorithmModels_pkey";
ALTER TABLE ONLY public."AlgorithmInstances" DROP CONSTRAINT "AlgorithmInstances_pkey";
ALTER TABLE ONLY public."AlgorithmInstanceTrainingInst" DROP CONSTRAINT "AlgorithmInstanceTrainingInst_pkey";
ALTER TABLE ONLY public."AlgorithmInstanceObjectModel" DROP CONSTRAINT "AlgorithmInstanceObjectModel_pkey";
ALTER TABLE ONLY public."AlgorithmInstanceDeployedDevices" DROP CONSTRAINT "AlgorithmInstanceDeployedDevices_pkey";
ALTER TABLE public.django_migrations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Workers" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Weights" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."ValidationInstructions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Users" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."TypeCode" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."TrainingInstructionsLabelDatasets" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."TrainingInstructions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."RoadConditions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."RelevantData" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."RecurrentCharges" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."QuestionXMLs" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."QualityMetricStruct" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Purchases" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Projects" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."ProjectInstructions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."ProjectEdgeNodes" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."OutsourcedInst" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Organizations" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."OperationInstances" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."OperationClassesSupportedLabelClasses" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."OperationClasses" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."ObjectModels" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."ObjectModelProject" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."ObjectModelFeatureModel" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."ObjectModelAlgorithmModel" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Manufacturers" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Licenses" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."LabelDatasets" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."LabelData" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."LabelClasses" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."HITsets" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Frames" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."FrameDatasetsProjects" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."FrameDatasets" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."FileStorage" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."FeatureModels" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."FeatureModelAlgorithm" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."FeatureInstances" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."FeatureInstanceAlgorithm" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."EventsHistory" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."EdgeNodes" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."EdgeNodeDevices" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."EcosystemsEdgeNodes" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Ecosystems" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DockerModels" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DockerModelFeatureModel" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DockerModelDeviceClasses" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DockerInstances" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Devices" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DevicePurchases" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DeviceParameters" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DeviceInstances" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DeviceImages" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DeviceClasses" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DetectionsSummary" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DetectedObjects" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DataSplitInstructions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."DataAcqInstructions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Categories" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."AugmentationInstructions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."Architectures" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."AnnotationInstructions" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."AlgorithmModels" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."AlgorithmInstances" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."AlgorithmInstanceTrainingInst" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."AlgorithmInstanceObjectModel" ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public."AlgorithmInstanceDeployedDevices" ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE public.recon_db_manager_deviceimage_id_seq;
...
DROP SEQUENCE public."ValidationInstructions_id_seq";
DROP TABLE public."ValidationInstructions";
DROP SEQUENCE public."Users_id_seq";
DROP TABLE public."Users";
DROP SEQUENCE public."TypeCode_id_seq";
DROP TABLE public."TypeCode";
DROP SEQUENCE public."TrainingInstructions_id_seq";
DROP SEQUENCE public."TrainingInstructionsLabelDatasets_id_seq";
DROP TABLE public."TrainingInstructionsLabelDatasets";
DROP TABLE public."TrainingInstructions";
DROP SEQUENCE public."RoadConditions_id_seq";
DROP TABLE public."RoadConditions";
DROP SEQUENCE public."RelevantData_id_seq";
DROP TABLE public."RelevantData";
DROP SEQUENCE public."RecurrentCharges_id_seq";
DROP TABLE public."RecurrentCharges";
DROP SEQUENCE public."QuestionXMLs_id_seq";
DROP TABLE public."QuestionXMLs";
DROP SEQUENCE public."QualityMetricStruct_id_seq";
DROP TABLE public."QualityMetricStruct";
DROP SEQUENCE public."Purchases_id_seq";
DROP TABLE public."Purchases";
DROP SEQUENCE public."Projects_id_seq";
DROP TABLE public."Projects";
DROP SEQUENCE public."ProjectInstructions_id_seq";
DROP TABLE public."ProjectInstructions";
DROP SEQUENCE public."ProjectEdgeNodes_id_seq";
DROP TABLE public."ProjectEdgeNodes";
DROP SEQUENCE public."OutsourcedInst_id_seq";
DROP TABLE public."OutsourcedInst";
DROP SEQUENCE public."Organizations_id_seq";
DROP TABLE public."Organizations";
DROP SEQUENCE public."OperationInstances_id_seq";
DROP TABLE public."OperationInstances";
DROP SEQUENCE public."OperationClasses_id_seq";
DROP SEQUENCE public."OperationClassesSupportedLabelClasses_id_seq";
DROP TABLE public."OperationClassesSupportedLabelClasses";
DROP TABLE public."OperationClasses";
DROP SEQUENCE public."ObjectModels_id_seq";
DROP TABLE public."ObjectModels";
DROP SEQUENCE public."ObjectModelProject_id_seq";
DROP TABLE public."ObjectModelProject";
DROP SEQUENCE public."ObjectModelFeatureModel_id_seq";
DROP TABLE public."ObjectModelFeatureModel";
DROP SEQUENCE public."ObjectModelAlgorithmModel_id_seq";
DROP TABLE public."ObjectModelAlgorithmModel";
...
DROP SEQUENCE public."LabelDatasets_id_seq";
DROP TABLE public."LabelDatasets";
DROP SEQUENCE public."LabelData_id_seq";
DROP TABLE public."LabelData";
DROP SEQUENCE public."LabelClasses_id_seq";
DROP TABLE public."LabelClasses";
DROP SEQUENCE public."HITsets_id_seq";
DROP TABLE public."HITsets";
DROP SEQUENCE public."Frames_id_seq";
DROP TABLE public."Frames";
DROP SEQUENCE public."FrameDatasets_id_seq";
DROP SEQUENCE public."FrameDatasetsProjects_id_seq";
DROP TABLE public."FrameDatasetsProjects";
DROP TABLE public."FrameDatasets";
DROP SEQUENCE public."FileStorage_id_seq";
DROP TABLE public."FileStorage";
DROP SEQUENCE public."FeatureModels_id_seq";
DROP TABLE public."FeatureModels";
DROP SEQUENCE public."FeatureModelAlgorithm_id_seq";
DROP TABLE public."FeatureModelAlgorithm";
DROP SEQUENCE public."FeatureInstances_id_seq";
DROP TABLE public."FeatureInstances";
DROP SEQUENCE public."FeatureInstanceAlgorithm_id_seq";
DROP TABLE public."FeatureInstanceAlgorithm";
DROP SEQUENCE public."EventsHistory_id_seq";
DROP TABLE public."EventsHistory";
DROP SEQUENCE public."EdgeNodes_id_seq";
DROP TABLE public."EdgeNodes";
DROP SEQUENCE public."EdgeNodeDevices_id_seq";
DROP TABLE public."EdgeNodeDevices";
DROP SEQUENCE public."Ecosystems_id_seq";
DROP SEQUENCE public."EcosystemsEdgeNodes_id_seq";
DROP TABLE public."EcosystemsEdgeNodes";
DROP TABLE public."Ecosystems";
DROP SEQUENCE public."DockerModels_id_seq";
DROP TABLE public."DockerModels";
DROP SEQUENCE public."DockerModelFeatureModel_id_seq";
DROP TABLE public."DockerModelFeatureModel";
DROP SEQUENCE public."DockerModelDeviceClasses_id_seq";
DROP TABLE public."DockerModelDeviceClasses";
DROP SEQUENCE public."DockerInstances_id_seq";
DROP TABLE public."DockerInstances";
DROP SEQUENCE public."Devices_id_seq";
DROP TABLE public."Devices";
DROP SEQUENCE public."DevicePurchases_id_seq";
DROP TABLE public."DevicePurchases";
DROP SEQUENCE public."DeviceParameters_id_seq";
DROP TABLE public."DeviceParameters";
DROP SEQUENCE public."DeviceInstances_id_seq";
DROP TABLE public."DeviceInstances";
DROP TABLE public."DeviceImages";
DROP SEQUENCE public."DeviceClasses_id_seq";
DROP TABLE public."DeviceClasses";
DROP SEQUENCE public."DetectionsSummary_id_seq";
DROP TABLE public."DetectionsSummary";
DROP SEQUENCE public."DetectedObjects_id_seq";
DROP TABLE public."DetectedObjects";
DROP SEQUENCE public."DataSplitInstructions_id_seq";
DROP TABLE public."DataSplitInstructions";
DROP SEQUENCE public."DataAcqInstructions_id_seq";
DROP TABLE public."DataAcqInstructions";
DROP SEQUENCE public."Categories_id_seq";
DROP TABLE public."Categories";
DROP SEQUENCE public."AugmentationInstructions_id_seq";
DROP TABLE public."AugmentationInstructions";
DROP SEQUENCE public."Architectures_id_seq";
DROP TABLE public."Architectures";
DROP SEQUENCE public."AnnotationInstructions_id_seq";
DROP TABLE public."AnnotationInstructions";
DROP SEQUENCE public."AlgorithmModels_id_seq";
DROP TABLE public."AlgorithmModels";
DROP SEQUENCE public."AlgorithmInstances_id_seq";
DROP TABLE public."AlgorithmInstances";
DROP SEQUENCE public."AlgorithmInstanceTrainingInst_id_seq";
DROP TABLE public."AlgorithmInstanceTrainingInst";
DROP SEQUENCE public."AlgorithmInstanceObjectModel_id_seq";
DROP TABLE public."AlgorithmInstanceObjectModel";
DROP SEQUENCE public."AlgorithmInstanceDeployedDevices_id_seq";
DROP TABLE public."AlgorithmInstanceDeployedDevices";
